...
import com.dimsum.eminentdomain.entity.Colonize;
...
public class GameScreen implements Screen {
	...
	public GameScreen(final EminentDomainGame game) {
		...
		// Initialise Textures
		textureAtlas = new TextureAtlas(Gdx.files.internal("assets.atlas")); //** button atlas image **//
...
//		}
	...
	private void addButtons() {
        ...
        TextButton showHandButton = new TextButton("Show Hand", style); //** Button text and style **//
		...
		TextButton drawCardButton = new TextButton("Draw Card", style); //** Button text and style **//
        drawCardButton.setPosition(_stage.getWidth() - 120, 10); //** Button location **//
